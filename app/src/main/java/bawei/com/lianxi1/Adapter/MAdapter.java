package bawei.com.lianxi1.Adapter;
...
import bawei.com.lianxi1.base.BaseViewHolder;
import bawei.com.lianxi1.imp.ViewHolder_01;
import bawei.com.lianxi1.imp.ViewHolder_02;
import bawei.com.lianxi1.util.TypeUtil;
...
public class MAdapter extends RecyclerView.Adapter<BaseViewHolder> implements TypeUtil{
    ...
    private void initOtherData() {
        for (int i = 0; i < communityBean.data.forum_list.size(); i++) {
			Log.e("sssssssssssssssssssssss",communityBean.data.forum_list.get(i).name);
